...
4. 보고서 양식에 붙여넣고, 특이사항 1~2줄만 수동 추가한다`,
  ...
  verification: {
    summary: "핵심 수치 5건을 샘플 데이터로 재계산 — 5건 일치",
    items: [
      {
        claim: "합계 매출 1,886,000원",
        basis: "샘플 12행의 amount 합계 (152,000+89,000+…+121,000)",
        status: "ok",
      },
      {
        claim: "online 채널 961,000원 (51.0%)",
        basis: "online 6행 합계 ÷ 전체 합계 1,886,000",
        status: "ok",
      },
      {
        claim: "partner 채널 595,000원 (31.5%)",
        basis: "partner 3행 합계 ÷ 전체 합계",
        status: "ok",
      },
      {
        claim: "SKU-101 매출 837,000원 — 최다",
        basis: "SKU-101 4행 합계, SKU-103(562,000)·SKU-102(487,000)와 비교",
        status: "ok",
      },
      {
        claim: "partner 건당 평균 단가 최고 (약 198,000원)",
        basis: "partner 595,000원 ÷ 3건 = 198,333원",
        status: "ok",
      },
    ],
  },
...
### 요약
- 전체 8건 중 **배송·환불·교환 관련 4건(50%)** (#1·#2·#3·#7) — 이 유형은 답변 템플릿 고정 가능
...
4. 나머지는 유형별 답변 초안으로 처리한다`,
        ...
        verification: {
          summary: "핵심 사실 3건을 입력 원문과 대조 — 3건 일치",
          items: [
            {
              claim: "배송·환불·교환 관련 4건 (50%)",
              basis: "입력 #1 배송 지연·#2 환불·#3 교환·#7 배송 오류 = 4건 ÷ 전체 8건",
              status: "ok",
            },
            {
              claim: "긴급 표시 2건",
              basis: "#1 배송 지연(높음)·#4 성분 표시 불일치(높음) — 원문의 지연·불일치 표현 근거",
              status: "ok",
            },
            {
              claim: "8개 행 전부 입력 문의와 1:1 대응",
              basis: "표의 #1~#8이 입력 문의 순번과 일치 — 원문에 없는 문의 없음",
              status: "ok",
            },
          ],
        },
...
| # | 액션 | 담당 | 기한 | 비고 |
|---|---|---|---|---|
| 1 | Q4 프로모션 시안 A/B 2종 제작 | 박디자인 | 금요일 | 민수 → 박디자인으로 담당 변경 |
| 2 | 신규 채널 단가표 검토 | 이영업 | 9/22 | 프로모션 진행 전 선행 |
| 3 | CS 응답 매뉴얼 배포 | 준호 | 수요일 | 지난주 문의 반영 |
| 4 | SKU-102 발주 확인 | 최물류 | 이번 주 | 재고 부족 |
...
4. 팀 채널에 붙여넣기 전 결정 사항이 사실과 맞는지 훑는다`,
        ...
        verification: {
          summary: "핵심 사실 4건을 회의록 발언과 대조 — 4건 일치",
          items: [
            {
              claim: "단가표 검토 — 이영업, 기한 9/22",
              basis: "이영업 발언 '신규 채널 단가표를 먼저 봐야 해요. 제가 9/22까지 검토하겠습니다'",
              status: "ok",
            },
            {
              claim: "프로모션 시안 — 박디자인, 기한 금요일",
              basis: "박디자인 발언 'A/B 두 개…금요일까지 가능합니다' + 김팀장의 담당 지정",
              status: "ok",
            },
            {
              claim: "CS 매뉴얼 배포 — 준호, 기한 수요일",
              basis: "김팀장 발언 '준호씨가 지난주 문의 반영해서 수요일까지 배포'",
              status: "ok",
            },
            {
              claim: "SKU-102 발주 확인 — 최물류",
              basis: "최물류 발언 'SKU-102 재고가 부족…발주는 제가 이번 주 안으로 확인'",
              status: "ok",
            },
          ],
        },
