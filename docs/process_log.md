...
| 날짜 | 단계 | 한 것 | 근거·링크 |
|---|---|---|---|
| 2026-09-18 | RULES | 대회 룰 확정 — 자유주제, live URL 제출, 예선 내부심사80+투표20, 본선(기획력·확장성·기술력·발표). 접수마감 9/19 00:00, 제출마감 9/21 00:00, 투표 9/21~10/6, 본선 10/7~10/16, 데모데이 10/17 | `docs/rules.md`, `docs/submission_checklist.md` — 공식 API(`/champion-api/api/v1/contests/current`) + 프론트 번들 실측. 제출 프로젝트 548개 확인 |
| 2026-09-18 | RESEARCH | 심사위원 5인 소속사 + 파트너사 8개사 리서치 — 관심사·전략·pain point·최근 6개월 | `docs/research/` 8개 파일, 출처 T1~T3 등급 |
| 2026-09-18 | PROBLEM | 문제 5개 도출(P1~P5) + sizing | `docs/problems.md`, `docs/opportunity_sizing.md` |
| 2026-09-18 | DECISION | 솔루션 후보 8개 → S2a "핏 번역기" 1차 채택(ICE 448) | `docs/decision.md`, `DECISIONS.md` |
| 2026-09-18 | DECISION | **S2a → A "업무→실행 자동화기"로 변경** — 사용자 기준(흔한 서비스 제외 + 심사위원 실제 문제). 차별성 축 추가 | `docs/decision.md`, `DECISIONS.md` |
